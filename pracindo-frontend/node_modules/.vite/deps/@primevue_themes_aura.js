...
var o$80 = { root: { borderRadius: "{content.border.radius}" } };
var t$37 = {
	root: {
		padding: "1rem",
		background: "{content.background}",
...
var r$53 = { icon: { color: "{form.field.icon.color}" } };
var i$14 = {
	root: {
		color: "{form.field.float.label.color}",
		focusColor: "{form.field.float.label.focus.color}",
...
//#endregion
//#region node_modules/@primevue/themes/aura/index.mjs
function _typeof(o) {
...
var index = _objectSpread(_objectSpread({}, e$52), {}, { components: {
	accordion: c$25,
	autocomplete: a$40,
	avatar: n$37,
	badge: d$31,
