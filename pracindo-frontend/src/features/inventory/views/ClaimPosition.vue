                ...
                <table class="w-full text-left text-sm table-auto min-w-[40rem]">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        <tr v-for="p in posisiKlaim" :key="p.entitas" class="hover:bg-slate-50/50 transition-colors">
                            ...
                            <td class="py-3.5 px-4 text-right text-emerald-600 font-medium">{{ angka(p.setor, 3) }}</td>
                            <td class="py-3.5 px-4 text-right text-amber-600 font-medium">{{ angka(p.ambil, 3) }}</td>
                    ...
                    <tfoot v-if="posisiKlaim.length">
                        <tr class="bg-slate-50/50 border-t-2 border-slate-200">
                            ...
                            <td class="py-3 px-4"></td>
                            <td class="py-3 px-4 text-right font-black text-slate-800">{{ angka(totalBersih, 3) }}</td>
                            <td class="py-3 px-4"></td>
                        </tr>
                    </tfoot>
                </table>
