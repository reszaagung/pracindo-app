<template>
  <div class="flex h-screen bg-[#F8FAFC] font-sans text-slate-700 overflow-hidden relative">
    ...
    <aside
      ...
      :class="[
        'lg:static lg:translate-x-0 lg:w-[88px] lg:h-[calc(100vh-2rem)] lg:m-4 lg:z-20',
...
const cekMobile = () => {
  ...
  // Saat berpindah dari mobile ke desktop, reset state drawer
  // supaya tidak "nyangkut" terbuka saat layar dikecilkan lagi nanti.
