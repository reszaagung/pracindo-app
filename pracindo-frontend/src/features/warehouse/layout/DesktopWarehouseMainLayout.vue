            ...
            <div class="flex flex-col items-center w-full gap-8">
                ...
                <nav class="flex flex-col gap-4 w-full px-4">
                    <router-link to="/warehouse" exact-active-class="bg-slate-900 text-white shadow-md"
                        class="w-12 h-12 rounded-2xl flex items-center justify-center transition-all duration-300 relative mx-auto group text-slate-400 hover:bg-slate-50 hover:text-slate-600" title="Penerimaan Barang">
                        <i class="pi pi-box text-xl group-hover:scale-110 transition-transform"></i>
                        <span class="absolute left-16 bg-slate-800 text-white text-xs font-semibold px-3 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 pointer-events-none whitespace-nowrap z-50 shadow-lg transition-opacity">Penerimaan Barang</span>
                    </router-link>
                    <router-link to="/warehouse/selisih" active-class="bg-slate-900 text-white shadow-md"
                        class="w-12 h-12 rounded-2xl flex items-center justify-center transition-all duration-300 relative mx-auto group text-slate-400 hover:bg-slate-50 hover:text-slate-600" title="Laporan Selisih">
                        <i class="pi pi-exclamation-triangle text-xl group-hover:scale-110 transition-transform"></i>
                        <span class="absolute left-16 bg-slate-800 text-white text-xs font-semibold px-3 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 pointer-events-none whitespace-nowrap z-50 shadow-lg transition-opacity">Laporan Selisih</span>
                    </router-link>
                </nav>
            </div>
