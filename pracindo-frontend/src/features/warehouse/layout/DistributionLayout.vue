<template>
    <div class="flex h-screen bg-[#F8FAFC] font-sans text-slate-700 overflow-hidden relative">
        ...
        <aside class="...">
            <!-- (Isi class <aside> dan <div> sidebar SAMA PERSIS dengan InputEntryLayout) -->
...
// Gunakan composable distribusi
const { menus, aktif } = useNavDistribution()

const kembali = () => router.push('/warehouse') // Sesuaikan rute asal
...
<style scoped>
/* (Style SAMA PERSIS dengan InputEntryLayout) */
.fade-enter-active,
.fade-leave-active {
